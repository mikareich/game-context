...
/** @class */
function () {
  function GameContext(ctx, width, height) {
    this.gameObjects = [];
    this.ctx = ctx;
    this.width = width;
    this.height = height;
  ...
  GameContext.loop = function (gameLoop, fps) {
    ...
    function interation(passedTime) {
      ...
      requestAnimationFrame(interation);
    }
  ...
  GameContext.prototype.update = function (updater) {
    ...
    this.gameObjects.forEach(function (gameObject) {
      ...
      gameObject.triggerListener("update");
    });
  };
  /**
  ...
  GameContext.prototype.draw = function (drawer, clearScreen) {
    ...
    this.gameObjects.forEach(function (gameObject) {
      var _a = gameObject.position,
          x = _a.x,
          y = _a.y;
      var width = gameObject.width,
          height = gameObject.height,
          background = gameObject.background;
      if (typeof drawer === "function") drawer(gameObject, _this, _this.ctx);else if (typeof background === "string") {
...
},{}],"GameObject.ts":[function(require,module,exports) {
"use strict";
...
var avatar = new GameObject_1.default({
  width: 100,
  height: 75
});
...
GameContext_1.default.loop(gameloop, 10);
},{"./GameContext":"GameContext.ts","./GameObject":"GameObject.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
