...
function (_super) {
  ...
  CollisionDetector.hasCollided = function (object1, object2) {
    var position1 = object1.getPosition();
    var position2 = object2.getPosition(); // Points of the Objects
    // <Edge><Object>
    ...
    var c2 = C2.y;
    var d2 = A2.x;
    var horizontalCondition = d1 <= b2 && b2 <= b1 || d1 <= d2 && d2 <= b1;
...
function () {
  function Game(ctx, width, height, withCollisionDetector) {
    ...
    this.width = width;
    this.height = height;
    if (withCollisionDetector) this.collisionDetector = new CollisionDetector_1.default([]);
